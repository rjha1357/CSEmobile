                ...
                <main className="wrapper pb-5">
                    ...
                    <div id="all" className="col s12">
                        ...
                        <div className="searchResult">
                            <div className="container">
                                <div className="searchResultcontent mt-3" style={searchResultcontent}>
                                    <p className="m-0">1-12 of 49 results for "2020 panini prizm"</p>
                                    <Link className="waves-effect waves-light btn modal-trigger sortBtn" sytle={sortBtn} to="#sortBy">Sort</Link>
                                </div>
                            </div>
                        </div>
